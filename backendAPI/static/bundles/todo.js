...
/******/ 	var hotCurrentHash = "d839bdc71a0a6ec0bd80"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire("./assets/js/todo.js")(__webpack_require__.s = "./assets/js/todo.js");
/******/ })
/************************************************************************/
/******/ ({
...
const store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* createStore */])(playList);

console.log(store.getState());
store.subscribe(() => {
    console.log('subscribe', store.getState());
    const list = document.querySelectorAll('.list')[0];
    store.dispatch().forEach(track => {
...
const addTrackBin = document.querySelectorAll('.addTrack')[0];
addTrackBin.addEventListener('click', () => {
