...
class List extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'exsistens' },
      this.state.articles.map((article, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'navigation', key: index, onMouseEnter: handlemove() },
        article.category
      )),
      ';',
      this.state.mouseMove ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'mouse' },
        'True mouse'
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(List, null), document.getElementById('root'));
