...
/******/ 	var hotCurrentHash = "3522c27b49055f6c0181"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire("./assets/js/index.js")(__webpack_require__.s = "./assets/js/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
class Navigation extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    async loadNavigation() {
        this.setState({
            categories: await __WEBPACK_IMPORTED_MODULE_2_isomorphic_fetch___default()("/api/v0/category").then(response => response.json())
        });
    }

    componentDidMount() {
        this.setState({ loading: true });
        let categories = __WEBPACK_IMPORTED_MODULE_2_isomorphic_fetch___default()('/api/v0/category').then(response => response.json()).then(json => json.map(categories => categories)).then(categories => this.setState({ categories, loading: false }));
    }
    render() {
        return this.state.loading ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            'div',
            { className: 'exsistens' },
            this.state.categories.map((category, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'navigation-category', key: index },
                category.category
            ))
        );
        // return(
        ...
        //             <div className="navigation-category" key={index}>{category.category}</div>
        //         ))}
        //
        //     </div>
        // )
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Navigation, null), document.getElementById('root'));
